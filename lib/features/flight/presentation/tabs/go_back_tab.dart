              ...
              children: [
                InkWell(
                  ...
                  child: GoItem(
                      ...
                      text1: 'Departure',
                      text2: FlightCubit.get(context)
                              .nameDepartureRoundTrip
                              .isEmpty
                ...
                InkWell(
                  ...
                  child: GoItem(
                      ...
                      text2: '${FlightCubit.get(context).selectedGoRoundDate}'
                          .substring(0, 10)),
                ),
                InkWell(
                  onTap: () {
                  ...
                  child: GoItem(
                      image: "assets/svg/calendar-edit.svg",
                      text1: 'Return Date',
                      text2: '${FlightCubit.get(context).selectedBackRoundDate}'
                          .substring(0, 10)),
                ),
                InkWell(
                  onTap: () {
                ...
                InkWell(
                  ...
                  child: GoItem(
                      ...
                      text1: 'Travel class',
                      text2:
                          FlightCubit.get(context).nameTravelRoundClass.isEmpty
                              ? 'Select Travel class'
